...
nnoremap <silent><nowait> <space>b <Cmd>Buffers<CR>
nnoremap <silent><nowait> <space>r <Cmd>Rg<CR>
nnoremap <silent><nowait> <space>f <Cmd>Files<CR>
" " barbar.nvim
